...
git push "https://$username:$password@github.com/carlosthe19916/sunat-web-services.git"

# Create tag and push
git tag "$releaseVersion"
git push "https://$username:$password@github.com/carlosthe19916/sunat-web-services.git" --tags
