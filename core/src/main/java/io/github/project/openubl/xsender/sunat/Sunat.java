...
public class Sunat {
    ...
    public SendFileResponse sendFile(
        ZipFile zipFile,
        FileDeliveryTarget fileDeliveryTarget,
        CompanyCredentials credentials
    ) {
        WsClientAuth clientAuth = WsClientAuth
            .builder()
    ...
    public VerifyTicketResponse verifyTicketStatus(
        String ticket,
        TicketDeliveryTarget target,
        CompanyCredentials credentials
    ) {
        WsClientAuth clientAuth = WsClientAuth
            .builder()
