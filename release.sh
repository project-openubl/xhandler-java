...
git push "https://$username:$password@github.com/project-openubl/xml-sender-ws.git"

# Create tag and push
git tag "$releaseVersion"
git push "https://$username:$password@github.com/project-openubl/xml-sender-ws.git" --tags
