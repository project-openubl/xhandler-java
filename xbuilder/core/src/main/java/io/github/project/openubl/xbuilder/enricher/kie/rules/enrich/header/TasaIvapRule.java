...
public class TasaIvapRule extends AbstractHeaderRule {

    @Override
    public boolean test(Object object) {
        return (isSalesDocument.test(object) && whenSalesDocument.apply(object)
                .map(documento -> documento.getTasaIvap() == null)
                .orElse(false)
        );
    }
    ...
    public void modify(Object object) {
        Consumer<SalesDocument> consumer = document -> document.setTasaIvap(getDefaults().getIvapTasa());
