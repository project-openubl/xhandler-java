...
class QuarkusXbuilderProcessor {
        ...
        void registerServices(BuildProducer<ServiceProviderBuildItem> services,
                ...
                services.produce(
                                new ServiceProviderBuildItem(RuleFactory.class.getName(),
                                                implementations.toArray(new String[0])));

                // register every listed implementation class for reflection so their
                // annotations can be read
                reflectiveClass.produce(
                                ReflectiveClassBuildItem.builder(implementations.toArray(new String[0]))
                                                .methods().build());
        }
        ...
        @BuildStep
        void jaxbRegisterClassesToBeBound(
                ...
                classesToBeBound.add(
                                io.github.project.openubl.xbuilder.content.jaxb.models.XMLCreditNote.class.getName());
                classesToBeBound.add(
                                io.github.project.openubl.xbuilder.content.jaxb.models.XMLDebitNote.class.getName());
                classesToBeBound.add(io.github.project.openubl.xbuilder.content.jaxb.models.XMLDespatchAdvice.class
                                .getName());
                classesToBeBound.add(io.github.project.openubl.xbuilder.content.jaxb.models.XMLVoidedDocuments.class
                                .getName());
                classesToBeBound
                                .add(io.github.project.openubl.xbuilder.content.jaxb.models.XMLSummaryDocuments.class
                                                .getName());
                classesToBeBound.add(
                                io.github.project.openubl.xbuilder.content.jaxb.models.XMLPercepcion.class.getName());
                classesToBeBound.add(
                                io.github.project.openubl.xbuilder.content.jaxb.models.XMLRetention.class.getName());
