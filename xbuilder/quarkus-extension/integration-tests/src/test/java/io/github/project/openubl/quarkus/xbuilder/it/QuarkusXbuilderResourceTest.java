...
public class QuarkusXbuilderResourceTest {
        ...
        public void testAllYamlFilesFromSnapshot() throws URISyntaxException, IOException {
                ...
                try (var walker = Files.walk(path, 5)) {
                        walker.filter(p -> !p.toFile().isDirectory())
                                        .forEach(p -> {
                                                try (var reader = Files.newBufferedReader(p)) {
                                                        Map<String, Object> yamlObject = yaml.load(reader);
                                                        String kind = (String) yamlObject.get("kind");
                                                        String snapshot = (String) yamlObject.get("snapshot");
                                                        Map<String, Object> input = (Map<String, Object>) yamlObject
                                                                        .get("input");

                                                        String jsonBody = JSON.toJSONString(input);

                                                        given()
                                                                        .when()
                                                                        .contentType(ContentType.JSON)
                                                                        .body(jsonBody)
                                                                        .post("/quarkus-xbuilder/" + kind
                                                                                        + "/from-json")
                                                                        .then()
                                                                        .statusCode(200)
                                                                        .body(is(snapshot));
        ...
        public void testInvoice() {
                ...
                given()
                                .when()
                                .contentType(ContentType.JSON)
                                .body(JSON.toJSONString(invoice))
        ...
        public void testCreditNote() {
                ...
                given()
                                .when()
                                .contentType(ContentType.JSON)
                                .body(JSON.toJSONString(creditNote))
        ...
        public void testDebitNote() {
                ...
                given()
                                .when()
                                .contentType(ContentType.JSON)
                                .body(JSON.toJSONString(debitNote))
        ...
        public void testVoidedDocuments() {
                ...
                given()
                                .when()
                                .contentType(ContentType.JSON)
                                .body(JSON.toJSONString(voidedDocuments))
        ...
        public void testSummaryDocuments() {
                ...
                given()
                                .when()
                                .contentType(ContentType.JSON)
                                .body(JSON.toJSONString(summaryDocuments))
        ...
        public void testPerception() {
                ...
                given()
                                .when()
                                .contentType(ContentType.JSON)
                                .body(JSON.toJSONString(perception))
        ...
        public void testRetention() {
                ...
                given()
                                .when()
                                .contentType(ContentType.JSON)
                                .body(JSON.toJSONString(retention))
        ...
        public void testDespatchAdvice() {
                ...
                given()
                                .when()
                                .contentType(ContentType.JSON)
                                .body(JSON.toJSONString(despatchAdvice))
